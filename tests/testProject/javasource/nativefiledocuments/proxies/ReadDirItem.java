...
public class ReadDirItem
{
	...
	{
		this(context, com.mendix.core.Core.instantiate(context, "NativeFileDocuments.ReadDirItem"));
	}
	...
	protected ReadDirItem(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixObject readDirItemMendixObject)
	{
		...
		if (!com.mendix.core.Core.isSubClassOf("NativeFileDocuments.ReadDirItem", readDirItemMendixObject.getType()))
			throw new java.lang.IllegalArgumentException("The given object is not a NativeFileDocuments.ReadDirItem");
	...
	{
		return "NativeFileDocuments.ReadDirItem";
	}
