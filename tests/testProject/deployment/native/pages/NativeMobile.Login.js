...
import { mainContent, sidebar } from "C:/Users/NathanRuth/Documents/Dev/nativeAudioRecorder/tests/testProject/deployment/native/layouts/Atlas_UI_Resources.NativePhone_TopBarOnly.js";
        ...
        content={[
            <$DataView key="p2.NativeMobile.Login.dataView2"
                ...
                object={NanoflowObjectProperty({
                    source: { "nanoflow": () => require("C:/Users/NathanRuth/Documents/Dev/nativeAudioRecorder/tests/testProject/deployment/native/nanoflows/NativeMobile.DSS_CreateLoginContext").DSS_CreateLoginContext },
                    argMap: {}
                })}
                content={[
                    ...
                    <$Button key="p2.NativeMobile.Login.actionButton2"
                        ...
                        onClick={ActionProperty({
                            action: { "type": "callNanoflow", "argMap": { "Login": { "widget": "p2.NativeMobile.Login.dataView2", "source": "object" } }, "config": { "nanoflow": () => require("C:/Users/NathanRuth/Documents/Dev/nativeAudioRecorder/tests/testProject/deployment/native/nanoflows/NativeMobile.ACT_SignInUser").ACT_SignInUser }, "disabledDuringExecution": false },
